/* CTSPentecostal — unit 11. Content only; all policy lives in cts-engine.js. */
window.CTS_UNIT = {
 "course": "pentecostal",
 "unit": 11,
 "totalUnits": 12,
 "filePrefix": "CTSPentecostal",
 "prevHref": "CTSPentecostalUnit10.html",
 "nextHref": "CTSPentecostalUnit12.html",
 "mc": [
  {
   "stem": {
    "en": "Alongside naming the prosperity gospel's error, this unit is equally careful to —",
    "es": "Junto con nombrar el error del evangelio de la prosperidad, esta unidad es igualmente cuidadosa en —"
   },
   "options": {
    "en": [
     "condemn the entire Pentecostal and charismatic movement for it",
     "avoid quoting Scripture at all",
     "refuse to charge the distortion to the whole movement, most of whom reject it",
     "declare all giving of money sinful"
    ],
    "es": [
     "condenar por ello a todo el movimiento pentecostal y carismático",
     "evitar del todo citar la Escritura",
     "rehusar cargar la distorsión a todo el movimiento, cuya mayoría la rechaza",
     "declarar pecaminoso todo dar de dinero"
    ]
   },
   "answer": 2,
   "why": {
    "en": "A teaching is judged on its own by the Word; a movement by its Scriptures and its faithful — so the error is named without condemning the many who reject it.",
  ...
  {
   "stem": {
    "en": "The grain of truth the prosperity impulse seizes upon is that —",
    "es": "El grano de verdad del que se apodera el impulso de la prosperidad es que —"
   },
   "options": {
    "en": [
     "God guarantees every believer wealth",
     "faith is a force that compels God",
     "sickness always proves hidden sin",
     "God is a generous Father who provides for His children and does heal"
    ],
    "es": [
     "Dios garantiza riqueza a todo creyente",
     "la fe es una fuerza que obliga a Dios",
     "la enfermedad siempre prueba pecado oculto",
     "Dios es un Padre generoso que provee para sus hijos y sí sana"
    ]
   },
   "answer": 3,
   "why": {
    "en": "The teaching gains a hearing by seizing on real truths — God's generosity and provision — before stretching them out of shape.",
    "es": "La enseñanza gana oído apoderándose de verdades reales — la generosidad y la provisión de Dios — antes de deformarlas."
   }
  },
  {
   "stem": {
    "en": "The distortion begins when the teaching adds that —",
    "es": "La distorsión comienza cuando la enseñanza añade que —"
   },
   "options": {
    "en": [
     "God cares about our daily needs",
     "health and wealth are guaranteed rights, faith is a formula, and sickness or poverty proves too little faith",
     "believers should be generous",
     "God is good and kind"
    ],
    "es": [
     "a Dios le importan nuestras necesidades diarias",
     "la salud y la riqueza son derechos garantizados, la fe es una fórmula, y la enfermedad o la pobreza prueban poca fe",
     "los creyentes deben ser generosos",
     "Dios es bueno y bondadoso"
    ]
   },
   "answer": 1,
   "why": {
    "en": "The error lies not in trusting God's provision but in the terms added: guaranteed wealth, faith as a lever, and blame on the afflicted.",
  ...
  {
   "stem": {
    "en": "Paul warns Timothy that —",
    "es": "Pablo advierte a Timoteo que —"
   },
   "options": {
    "en": [
     "those who desire to be rich fall into a snare, and the love of money is a root of all kinds of evil",
     "godliness is a means of financial gain",
     "the rich are the most faithful believers",
     "contentment is worthless"
    ],
    "es": [
     "los que quieren enriquecerse caen en lazo, y el amor al dinero es raíz de todos los males",
     "la piedad es un medio de ganancia financiera",
     "los ricos son los creyentes más fieles",
     "el contentamiento no vale nada"
    ]
   },
   "answer": 0,
   "why": {
    "en": "1 Timothy 6:9–10 makes riches a danger, not a goal, and lifts up godliness with contentment as the true gain.",
  ...
  {
   "stem": {
    "en": "On suffering, the New Testament teaches that —",
    "es": "Sobre el sufrimiento, el Nuevo Testamento enseña que —"
   },
   "options": {
    "en": [
     "true faith removes all hardship",
     "sickness is always a verdict on sin",
     "Christ promised His followers ease",
     "all who desire to live godly will suffer persecution, and we are heirs if indeed we suffer with Him"
    ],
    "es": [
     "la fe verdadera quita toda dificultad",
     "la enfermedad es siempre un veredicto sobre el pecado",
     "Cristo prometió comodidad a sus seguidores",
     "todos los que quieran vivir piadosamente padecerán persecución, y somos herederos si es que padecemos con Él"
    ]
   },
   "answer": 3,
   "why": {
    "en": "2 Timothy 3:12 and Romans 8:17 place the believer's road through the cross, not around it.",
    "es": "2 Timoteo 3:12 y Romanos 8:17 ponen el camino del creyente por la cruz, no alrededor de ella."
   }
  },
  {
   "stem": {
    "en": "When Paul asked three times for his thorn to be removed, God's answer was —",
    "es": "Cuando Pablo pidió tres veces que le fuese quitado su aguijón, la respuesta de Dios fue —"
   },
   "options": {
    "en": [
     "that Paul plainly lacked faith",
     "to remove it at once as a reward",
     "My grace is sufficient for you, for My strength is made perfect in weakness",
     "complete silence"
    ],
    "es": [
     "que a Pablo claramente le faltaba fe",
     "quitarlo de inmediato como recompensa",
   ...
   "answer": 2,
   "why": {
    "en": "2 Corinthians 12:9 shows faith as trust in God's will, not a technique that guarantees relief.",
    "es": "2 Corintios 12:9 muestra la fe como confianza en la voluntad de Dios, no una técnica que garantiza alivio."
   }
  },
  {
   "stem": {
    "en": "A movement, this unit argues, must be judged —",
    "es": "Un movimiento, argumenta esta unidad, debe ser juzgado —"
   },
   "options": {
    "en": [
     "by its Scriptures and its faithful, while a teaching is judged on its own terms by the Word",
     "by its worst and most famous preachers",
     "by its television programs",
     "not at all"
    ],
    "es": [
     "por sus Escrituras y sus fieles, mientras que una enseñanza se juzga por sí misma según la Palabra",
   ...
   "answer": 0,
   "why": {
    "en": "To charge the distortion to the whole movement would be unjust; the many faithful reject it for the same reason we do.",
 ...
 "sa": [
  {
   "prompt": {
    "en": "State the two things this unit is careful to do at once when it addresses the prosperity gospel, and why both matter.",
  ...
  {
   "prompt": {
    "en": "Give three ways Scripture corrects the prosperity gospel's view of faith, wealth, and suffering.",
  ...
  {
   "prompt": {
    "en": "Explain how a pastor should warn against the prosperity gospel and other excesses without wounding faithful believers.",
