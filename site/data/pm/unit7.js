/* CTSPM — unit 7. Content only; all policy lives in cts-engine.js. */
window.CTS_UNIT = {
 "course": "pm",
 "unit": 7,
 "totalUnits": 12,
 "filePrefix": "CTSPM",
 "prevHref": "CTSPMUnit6.html",
 "nextHref": "CTSPMUnit8.html",
 "mc": [
  {
   "stem": {
    "en": "The pastor's most lasting ministry, according to this unit, is:",
    "es": "El ministerio más duradero del pastor, según esta unidad, es:"
   },
   "options": {
    "en": [
     "The pulpit",
   ...
   "answer": 3,
   "why": {
    "en": "The pastor's most lasting ministry is discipleship — multiplying himself into others.",
    "es": "El ministerio más duradero del pastor es el discipulado — multiplicarse en otros."
   }
  },
  {
   "stem": {
    "en": "Ephesians 4:11 likely describes pastor and teacher as:",
    "es": "Efesios 4:11 probablemente describe pastor y maestro como:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "Ephesians 4:11 likely describes one combined office — the pastor-teacher.",
    "es": "Efesios 4:11 probablemente describe un oficio combinado — el pastor-maestro."
   }
  },
  {
   "stem": {
    "en": "The purpose of pastors and teachers, per Ephesians 4:12, is:",
    "es": "El propósito de pastores y maestros, según Efesios 4:12, es:"
   },
   "options": {
    "en": [
   ...
   "answer": 2,
   "why": {
    "en": "The purpose of pastors and teachers is to equip the saints for the work of ministry.",
    "es": "El propósito de pastores y maestros es equipar a los santos para la obra del ministerio."
   }
  },
  {
   "stem": {
    "en": "The professor served as a seminary professor for approximately:",
    "es": "El profesor sirvió como profesor de seminario por aproximadamente:"
   },
   "options": {
    "en": [
     "Eleven years",
   ...
   "answer": 0,
   "why": {
    "en": "The professor served as a seminary professor for approximately eleven years.",
    "es": "El profesor sirvió como profesor de seminario por aproximadamente once años."
   }
  },
  {
   "stem": {
    "en": "The Great Commission's third movement, often neglected, is:",
    "es": "El tercer movimiento de la Gran Comisión, a menudo descuidado, es:"
   },
   "options": {
    "en": [
     "Going",
   ...
   "answer": 1,
   "why": {
    "en": "The neglected third movement of the Great Commission is teaching them to observe all Christ commanded.",
    "es": "El tercer movimiento descuidado de la Gran Comisión es enseñarles a guardar todo lo que Cristo mandó."
   }
  },
  {
   "stem": {
    "en": "2 Timothy 2:2 describes how many generations of teaching?",
    "es": "2 Timoteo 2:2 describe ¿cuántas generaciones de enseñanza?"
   },
   "options": {
    "en": [
     "One",
   ...
   "answer": 3,
   "why": {
    "en": "2 Timothy 2:2 describes four generations of teaching.",
    "es": "2 Timoteo 2:2 describe cuatro generaciones de enseñanza."
   }
  },
  {
   "stem": {
    "en": "In 2 Timothy 2:2, the four generations are:",
    "es": "En 2 Timoteo 2:2, las cuatro generaciones son:"
   },
   "options": {
    "en": [
   ...
   "answer": 2,
   "why": {
    "en": "The four generations are Paul, Timothy, faithful men, and others also.",
    "es": "Las cuatro generaciones son Pablo, Timoteo, hombres fieles y también otros."
   }
  },
  {
   "stem": {
    "en": "The four elements of the Paul-Timothy relationship include all EXCEPT:",
    "es": "Los cuatro elementos de la relación Pablo-Timoteo incluyen todos EXCEPTO:"
   },
   "options": {
    "en": [
     "Time together",
   ...
   "answer": 1,
   "why": {
    "en": "Financial support contracts is NOT one of the four Paul-Timothy mentoring elements.",
    "es": "Los contratos de apoyo financiero NO son uno de los cuatro elementos de mentoría de Pablo-Timoteo."
   }
  },
  {
   "stem": {
    "en": "The four levels at which a pastor teaches are:",
    "es": "Los cuatro niveles en los cuales un pastor enseña son:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "The four teaching levels are pulpit, Bible study, small group, and one-on-one.",
    "es": "Los cuatro niveles de enseñanza son púlpito, estudio bíblico, grupo pequeño e individual."
   }
  },
  {
   "stem": {
    "en": "The deepest level of pastoral teaching is:",
    "es": "El nivel más profundo de enseñanza pastoral es:"
   },
   "options": {
    "en": [
     "The pulpit",
   ...
   "answer": 2,
   "why": {
    "en": "The deepest level of pastoral teaching is the one-on-one conversation.",
    "es": "El nivel más profundo de enseñanza pastoral es la conversación individual."
   }
  },
  {
   "stem": {
    "en": "The pastor uses 1 Timothy 3 / Titus 1 qualifications best as:",
    "es": "El pastor usa las calificaciones de 1 Timoteo 3 / Tito 1 mejor como:"
   },
   "options": {
    "en": [
   ...
   "answer": 3,
   "why": {
    "en": "The elder qualifications work best as a curriculum for forming the next generation of leaders.",
    "es": "Las cualificaciones del anciano sirven mejor como currículo para formar la próxima generación de líderes."
   }
  },
  {
   "stem": {
    "en": "Arthur, the inmate the professor knew, became:",
    "es": "Arthur, el recluso que el profesor conoció, se convirtió en:"
   },
   "options": {
    "en": [
     "A pastor in Texas",
   ...
   "answer": 1,
   "why": {
    "en": "Arthur became head chaplain at Parchman Prison in Mississippi.",
    "es": "Arthur llegó a ser capellán principal de la prisión de Parchman en Misisipi."
   }
  },
  {
   "stem": {
    "en": "Arthur came to Christ:",
    "es": "Arthur vino a Cristo:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "Arthur came to Christ inside Angola Prison after considering taking his life.",
    "es": "Arthur vino a Cristo dentro de la prisión de Angola tras considerar quitarse la vida."
   }
  },
  {
   "stem": {
    "en": "The pastor who only thinks one Sunday at a time will likely:",
    "es": "El pastor que solo piensa en un domingo a la vez probablemente:"
   },
   "options": {
    "en": [
   ...
   "answer": 2,
   "why": {
    "en": "The pastor who only thinks one Sunday at a time will likely burn out by his fifth year.",
    "es": "El pastor que solo piensa un domingo a la vez probablemente se agotará para su quinto año."
   }
  },
  {
   "stem": {
    "en": "1 Corinthians 3:6 teaches that:",
    "es": "1 Corintios 3:6 enseña que:"
   },
   "options": {
    "en": [
   ...
   "answer": 1,
   "why": {
    "en": "1 Corinthians 3:6 teaches Paul plants, Apollos waters, but God gives the increase.",
    "es": "1 Corintios 3:6 enseña que Pablo planta, Apolos riega, pero Dios da el crecimiento."
   }
  },
  {
   "stem": {
    "en": "A pastor who has stopped learning will, by his fifteenth year:",
    "es": "Un pastor que ha dejado de aprender, para su decimoquinto año:"
   },
   "options": {
    "en": [
   ...
   "answer": 3,
   "why": {
    "en": "A pastor who stops learning will, by his fifteenth year, be repeating himself with shallow teaching.",
    "es": "Un pastor que deja de aprender, para su decimoquinto año, se repetirá con enseñanza superficial."
   }
  },
  {
   "stem": {
    "en": "John Drakeford, whose counseling methodology the professor incorporates, taught at:",
    "es": "John Drakeford, cuya metodología de consejería incorpora el profesor, enseñó en:"
   },
   "options": {
    "en": [
   ...
   "answer": 1,
   "why": {
    "en": "John Drakeford taught at Southwestern Baptist Theological Seminary.",
    "es": "John Drakeford enseñó en el Seminario Teológico Bautista del Suroeste."
   }
  },
  {
   "stem": {
    "en": "John Drakeford himself studied under:",
    "es": "El propio John Drakeford estudió bajo:"
   },
   "options": {
    "en": [
     "Carl Rogers",
   ...
   "answer": 2,
   "why": {
    "en": "John Drakeford himself studied under O. Hobart Mowrer.",
    "es": "John Drakeford mismo estudió bajo O. Hobart Mowrer."
   }
  },
  {
   "stem": {
    "en": "The Mowrer → Drakeford → Wayne → next generation chain illustrates:",
    "es": "La cadena Mowrer → Drakeford → Wayne → próxima generación ilustra:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "The Mowrer-Drakeford-Wayne chain illustrates 2 Timothy 2:2 lived out across generations.",
    "es": "La cadena Mowrer-Drakeford-Wayne ilustra 2 Timoteo 2:2 vivido a través de generaciones."
   }
  },
  {
   "stem": {
    "en": "The faithful pastor's voice, after his pulpit ministry ends, continues:",
    "es": "La voz del pastor fiel, después de que termina su ministerio del púlpito, continúa:"
   },
   "options": {
    "en": [
     "Only in recordings",
   ...
   "answer": 3,
   "why": {
    "en": "The faithful pastor's voice continues through every disciple he ever poured his life into.",
    "es": "La voz del pastor fiel continúa a través de cada discípulo en quien derramó su vida."
   }
  }
 ],
 "sa": [
  {
   "prompt": {
    "en": "Explain why the pastor's primary job, per Ephesians 4:11-12, is to equip the saints rather than to do all the ministry himself. Apply this to a typical local church.",
    "es": "Explique por qué el trabajo principal del pastor, según Efesios 4:11-12, es equipar a los santos en lugar de hacer todo el ministerio él mismo. Aplique esto a una iglesia local típica."
   },
   "keywords": {
    "en": [
     "equip",
