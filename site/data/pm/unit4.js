/* CTSPM — unit 4. Content only; all policy lives in cts-engine.js. */
window.CTS_UNIT = {
 "course": "pm",
 "unit": 4,
 "totalUnits": 12,
 "filePrefix": "CTSPM",
 "prevHref": "CTSPMUnit3.html",
 "nextHref": "CTSPMUnit5.html",
 "mc": [
  {
   "stem": {
    "en": "Jesus's most concise definition of worship comes from:",
    "es": "La definición más concisa de adoración de Jesús viene de:"
   },
   "options": {
    "en": [
     "John 3:16",
   ...
   "answer": 2,
   "why": {
    "en": "Jesus's most concise definition of worship comes from John 4:24 — in spirit and in truth.",
    "es": "La definición más concisa de adoración de Jesús viene de Juan 4:24 — en espíritu y en verdad."
   }
  },
  {
   "stem": {
    "en": "The two pillars of biblical worship are:",
    "es": "Los dos pilares de la adoración bíblica son:"
   },
   "options": {
    "en": [
     "Music and prayer",
   ...
   "answer": 1,
   "why": {
    "en": "The two pillars of biblical worship are spirit and truth; both must be present.",
    "es": "Los dos pilares de la adoración bíblica son espíritu y verdad; ambos deben estar presentes."
   }
  },
  {
   "stem": {
    "en": "Hannah at the temple was mistaken by Eli for being:",
    "es": "Ana en el templo fue confundida por Elí como:"
   },
   "options": {
    "en": [
     "Possessed",
   ...
   "answer": 1,
   "why": {
    "en": "Hannah prayed so intensely that Eli mistook her for being drunk.",
    "es": "Ana oró tan intensamente que Elí la confundió con estar ebria."
   }
  },
  {
   "stem": {
    "en": "At Pentecost, the bystanders said the disciples were:",
    "es": "En Pentecostés, los espectadores dijeron que los discípulos estaban:"
   },
   "options": {
    "en": [
     "Full of new wine",
   ...
   "answer": 0,
   "why": {
    "en": "At Pentecost the bystanders said the Spirit-filled disciples were full of new wine.",
    "es": "En Pentecostés los presentes dijeron que los discípulos llenos del Espíritu estaban llenos de mosto."
   }
  },
  {
   "stem": {
    "en": "Ephesians 5:18 contrasts being drunk with wine with being:",
    "es": "Efesios 5:18 contrasta estar embriagado con vino con estar:"
   },
   "options": {
    "en": [
     "Asleep",
   ...
   "answer": 3,
   "why": {
    "en": "Ephesians 5:18 contrasts being drunk with wine with being filled with the Spirit.",
    "es": "Efesios 5:18 contrasta el embriagarse con vino con ser lleno del Espíritu."
   }
  },
  {
   "stem": {
    "en": "The 'drink poison thinking it's medicine' illustration warns against:",
    "es": "La ilustración de 'beber veneno pensando que es medicina' advierte contra:"
   },
   "options": {
    "en": [
     "Modern medicine",
   ...
   "answer": 2,
   "why": {
    "en": "The 'poison as medicine' image warns against sincerity without truth.",
    "es": "La imagen del 'veneno como medicina' advierte contra la sinceridad sin verdad."
   }
  },
  {
   "stem": {
    "en": "Paul and Silas in the Philippian jail at midnight illustrate:",
    "es": "Pablo y Silas en la cárcel de Filipos a medianoche ilustran:"
   },
   "options": {
    "en": [
   ...
   "answer": 3,
   "why": {
    "en": "Paul and Silas singing in the Philippian jail show worship in spirit and truth even in suffering.",
    "es": "Pablo y Silas cantando en la cárcel de Filipos muestran adoración en espíritu y verdad aun en sufrimiento."
   }
  },
  {
   "stem": {
    "en": "The African widow who came early to whisper prayers illustrates:",
    "es": "La viuda africana que venía temprano a susurrar oraciones ilustra:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "The African widow coming early to whisper prayers illustrates heart preparation before the service.",
    "es": "La viuda africana que llegaba temprano a susurrar oraciones ilustra la preparación del corazón antes del servicio."
   }
  },
  {
   "stem": {
    "en": "The pastor's role as worship leader is first:",
    "es": "El papel del pastor como guía de adoración es primero:"
   },
   "options": {
    "en": [
     "Musical",
   ...
   "answer": 2,
   "why": {
    "en": "The pastor's role as worship leader is first internal — preparing his own heart.",
    "es": "El papel del pastor como líder de adoración es primero interno — preparar su propio corazón."
   }
  },
  {
   "stem": {
    "en": "Songs sung in worship are properly understood as:",
    "es": "Los cánticos cantados en adoración se entienden propiamente como:"
   },
   "options": {
    "en": [
     "Filler material",
   ...
   "answer": 1,
   "why": {
    "en": "Songs in worship are properly understood as theology set to melody.",
    "es": "Los cantos en la adoración se entienden propiamente como teología puesta en melodía."
   }
  },
  {
   "stem": {
    "en": "The benediction at the end of the service is:",
    "es": "La bendición al final del servicio es:"
   },
   "options": {
    "en": [
   ...
   "answer": 3,
   "why": {
    "en": "The benediction is the pastor speaking God's favor on His people for the week.",
    "es": "La bendición es el pastor hablando el favor de Dios sobre Su pueblo para la semana."
   }
  },
  {
   "stem": {
    "en": "Christ left His church how many ordinances?",
    "es": "Cristo dejó a Su iglesia ¿cuántas ordenanzas?"
   },
   "options": {
    "en": [
     "Four",
   ...
   "answer": 2,
   "why": {
    "en": "Christ left His church two ordinances: baptism and the Lord's Supper.",
    "es": "Cristo dejó a Su iglesia dos ordenanzas: el bautismo y la Cena del Señor."
   }
  },
  {
   "stem": {
    "en": "The biblical order regarding faith and baptism is always:",
    "es": "El orden bíblico respecto a la fe y el bautismo es siempre:"
   },
   "options": {
    "en": [
     "Faith, then baptism",
   ...
   "answer": 0,
   "why": {
    "en": "The biblical order is always faith first, then baptism.",
    "es": "El orden bíblico es siempre la fe primero, luego el bautismo."
   }
  },
  {
   "stem": {
    "en": "Romans 6:3-4 teaches that baptism is a picture of:",
    "es": "Romanos 6:3-4 enseña que el bautismo es un cuadro de:"
   },
   "options": {
    "en": [
     "Cleansing only",
   ...
   "answer": 1,
   "why": {
    "en": "Romans 6:3-4 teaches baptism is a picture of death and resurrection with Christ.",
    "es": "Romanos 6:3-4 enseña que el bautismo es un cuadro de muerte y resurrección con Cristo."
   }
  },
  {
   "stem": {
    "en": "The historic Baptist position on the Lord's Supper is:",
    "es": "La posición histórica bautista sobre la Cena del Señor es:"
   },
   "options": {
    "en": [
     "Transubstantiation",
   ...
   "answer": 3,
   "why": {
    "en": "The historic Baptist position is the memorial view — symbols pointing to a real sacrifice.",
    "es": "La posición bautista histórica es la vista memorial — símbolos que señalan a un sacrificio real."
   }
  },
  {
   "stem": {
    "en": "The doctrine that the bread and wine literally become the body and blood of Christ is called:",
    "es": "La doctrina de que el pan y el vino se convierten literalmente en el cuerpo y la sangre de Cristo se llama:"
   },
   "options": {
    "en": [
     "Transubstantiation",
   ...
   "answer": 0,
   "why": {
    "en": "Transubstantiation is the doctrine that bread and wine literally become Christ's body and blood.",
    "es": "La transubstanciación es la doctrina de que el pan y el vino literalmente se vuelven el cuerpo y sangre de Cristo."
   }
  },
  {
   "stem": {
    "en": "The 12 stones at the Jordan (Joshua 4) and the Passover meal (Exodus 12) are examples of:",
    "es": "Las 12 piedras en el Jordán (Josué 4) y la cena de la Pascua (Éxodo 12) son ejemplos de:"
   },
   "options": {
    "en": [
   ...
   "answer": 2,
   "why": {
    "en": "The Jordan stones and the Passover are God's physical reminders of spiritual realities.",
    "es": "Las piedras del Jordán y la Pascua son recordatorios físicos de Dios de realidades espirituales."
   }
  },
  {
   "stem": {
    "en": "1 Corinthians 11:28-30 warns that taking the Lord's Supper unworthily can result in:",
    "es": "1 Corintios 11:28-30 advierte que tomar la Cena del Señor indignamente puede resultar en:"
   },
   "options": {
    "en": [
     "Excommunication",
   ...
   "answer": 3,
   "why": {
    "en": "1 Corinthians 11 warns that taking the Supper unworthily can bring weakness, sickness, and death.",
    "es": "1 Corintios 11 advierte que tomar la Cena indignamente puede traer debilidad, enfermedad y muerte."
   }
  },
  {
   "stem": {
    "en": "Which is NOT one of the four common errors in public worship?",
    "es": "¿Cuál NO es uno de los cuatro errores comunes en la adoración pública?"
   },
   "options": {
    "en": [
     "Entertainment",
   ...
   "answer": 1,
   "why": {
    "en": "Long sermons is NOT one of the four common worship errors named in the unit.",
    "es": "Los sermones largos NO son uno de los cuatro errores comunes de adoración nombrados en la unidad."
   }
  },
  {
   "stem": {
    "en": "The pastor's job in worship is fundamentally to:",
    "es": "El trabajo del pastor en la adoración es fundamentalmente:"
   },
   "options": {
    "en": [
   ...
   "answer": 0,
   "why": {
    "en": "The pastor's fundamental job in worship is to lead the people into the presence of the living God.",
    "es": "El trabajo fundamental del pastor en la adoración es llevar al pueblo a la presencia del Dios vivo."
   }
  }
 ],
 "sa": [
  {
   "prompt": {
    "en": "Define worship biblically using John 4:24. Why must both pillars (spirit and truth) be present, and what happens when one is missing?",
    "es": "Defina la adoración bíblicamente usando Juan 4:24. ¿Por qué deben estar presentes ambos pilares (espíritu y verdad), y qué sucede cuando uno falta?"
   },
   "keywords": {
    "en": [
     "spirit",
