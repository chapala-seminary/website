/* Exam engine for CTSBible (shared by 8 unit pages).
   Extracted from those pages' inline <script>; per-unit config and
   question banks live in data/bible/unitN.js. */
/* ===== CTS "How We Got the Bible" — Unit 2 — immediate-feedback engine ===== */
...
function updateCompletion(){
  ...
  if(complete){
    ...
    banner.textContent = currentLang === 'en'
      ? (`\u2705 Unit ${UNIT} complete on the ` + trackName + ' track. Well done.')
      : (`\u2705 Unidad ${UNIT} completada en la v\u00eda ` + trackName + '. Bien hecho.');
  } else {
