/* Exam engine for CTSNT (shared by 10 unit pages).
...
if (PREV_URL) document.getElementById('prevUnitBtn').onclick = () => { location.href = PREV_URL; };
...
function submitExam() {
    ...
    function passUnit() {
        ...
        localStorage.setItem(`nt_unit${UNIT}_passed`, 'true');
